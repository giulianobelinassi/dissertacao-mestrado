...
\begin{tikzpicture}[node distance = 3cm, auto]
    % Place nodes
    \node [block, comp1]                         (make)   {Makefile};
    \coordinate[below of=make]            (c);
    \node [block, below of=c]         (fonte1) {fonte1.c};
    \node [block, below of=c, right of=fonte1]         (fonte2) {fonte2.cpp};
    \node [block, below of=c, right of=fonte2, right of=fonte1]         (fonte3) {fonte3.f90};
    ...
    % Draw edges
    \draw[->]    (make.south)   -- (fonte1.north);
    \draw[->]    (make.south)   -- (fonte2.north);
    \draw[->]    (make.south)   -- (fonte3.north);
