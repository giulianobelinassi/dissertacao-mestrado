...
compartilhadas, como no caso de um compilador que dê suporte ambos C e C++. 
...
\begin{itemize}
    ...
    \item LR($k$): Um algoritmo que tenta construir a AST das folhas para a raiz.
		  ...
		  em conjunto com uma pilha, e sua codificação é mais complicada.
          Porém, esse algoritmo consegue processar gramáticas mais complexas que
...
\end{itemize}
	A complexidade os analisadores LL($k$) e LR($k$) é $O(n)$, onde $n$ 
