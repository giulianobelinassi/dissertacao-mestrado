...
além do seu uso clássico do processo de compilação de um programa. Por fim, é
apresentado alguns conceitos e ferramentas básicas sobre Computação Paralela.
...
Denote como \textit{Linguagem Fonte} como sendo a linguagem
...
\begin{itemize}
	...
	É neste módulo que é executado a análise léxica e sintática, com a
        finalidade de construir da a Árvore de Sintaxe Abstrata (AST), para que em
...
eficiente para todas as Linguagens Alvo suportadas pelo
compilador.
...
gerando possívelmente um código suboptimal. Usualmente, cada um desses arquivos
...
seja utilizado o máximo dos recursos computacionais disponíveis.
    ...
    Nessa seção é discutida alguns conceitos básicos de computação
...
suportado pelo Linux \citep{shmget}.
...
valor 0, a \textit{thread} que em sequência tentar decrementá-lo será bloqueado. A
