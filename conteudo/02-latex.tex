...
GCC. São estas linguagens: GENERIC, GIMPLE, CGRAPH, e RTL
...
\begin{subsection}{GIMPLE}
    ...
    O GIMPLE é outra linguagem intermediária do GCC, basicamente consistindo
na conversão de GENERIC para \textit{Three Address Code}.
