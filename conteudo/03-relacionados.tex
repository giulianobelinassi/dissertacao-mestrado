...
parallelization of the \LR{$0$} algorithm. Their idea consisted of breaking the
...
\item LTRANS (\textit{Local Transformations}): it applies the transformations generated by
...
wrapper is represented by \textit{collect2}, which firstly launches \textit{lto1}
in WPA mode, and in the second time it finally launches \textit{ld}. This process
