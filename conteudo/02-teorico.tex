...
to understand the compilation phases. Following that, we briefly discuss how the
...
Parallel Computing and some intuition about power and energy.
...
There is also a slight variant of this machine called Nondeterministic Finite Automata (\ttt{NFA}).
...
There is also a important undesired detail about grammars called ambiguity, which
...
\begin{section}{Callgraphs and Interprocedural Analysis}
...
\begin{subsection}{Register Allocation}
	...
	This is the purpose of \textit{register allocation}. An code in an
	...
	consider the Figure \ref{fig:register_ir}. In (a), we have an sketch of
...
\begin{subsection}{Instruction Selection}
	...
	by the final code locally for each line of the Intermediate Representation. This has the advantage
...
\end{figure}
	...
	Another approach is to treat the Intermediate Representation as a \textit{tree}, then try to pattern-match
...
Compilers are large programs. Because if this, there is a great interest in
...
\begin{section}{The GCC Compiler}
...
\begin{section}{Parallel Computing}
