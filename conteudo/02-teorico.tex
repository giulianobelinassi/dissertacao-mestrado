...
%Eu achei a frase seguinte meio confusa, tentei consertar, mas veja se não modifiquei o significado.
...
%Essa parte de outras funcionalidades, não sei se separei certo, mas não estava claro a enumeração
...
% Não entendi "que aqui estão representadas como originalmente"
...
%Tem muito "registradores" na frase a baixo /o\ dá para reformular para reduzir a repetição?
...
% A linguagem ser uma etapa é estranho: "A tradução para essa linguagem" é uma opção.
...
LD, o montador AS, e outras ferramentas\footnote{\url{https://www.gnu.org/software/binutils/}}.
     % o que é "providenciar" na frase abaixo?
...
% Muito confusa a frase seguinte:
