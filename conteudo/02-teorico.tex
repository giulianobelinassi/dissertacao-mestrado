...
Há também técnicas para selecionar instruções de maneira ótima através
de Programação Dinâmica. A ideia consiste em observar que para minimizar o custo
de selecionar os padrões na árvore inteira, basta considerar o melhor custo dos filhos
...
\[
    DP[n] =
     \begin{cases}
       ...
       \min_{p \in P_n} CUSTO[p] + \sum_{f \in FILHO[n]} DP[f] &\quad\text{ caso contrário.}\\
     \end{cases}
\]
