...
compilador. Conseguimos \textit{speedups} num intervalo entre $0.7\times$ até $3.53\times$ ao compilar
arquivos individuais, e até $35\%$ de \textit{speedup} ao compilar projetos
inteiros usando um destes métodos, em contraste com utilizando exclusivamente o
...
individual files, and up to $35\%$ of speedup when compiling entire projects
contrasting with \texttt{make} alone. We also present the related works on the
