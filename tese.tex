...
\newcommand{\sqsq}{\ensuremath{\sqsubseteq}\xspace}
\newcommand{\union}{\mathop{\bigcup}\displaylimits}

\newcommand{\ttt}[1]{\texttt{#1}\xspace}
\newcommand{\DFA}{\texttt{DFA}\xspace}
\newcommand{\NFA}{\texttt{NFA}\xspace}
\newcommand{\PDA}{\texttt{PDA}\xspace}
\newcommand{\DPDA}{\texttt{DPDA}\xspace}
\newcommand{\CFG}{\texttt{CFG}\xspace}
\newcommand{\DCFG}{\texttt{DCFG}\xspace}
\newcommand{\LR}[1]{\texttt{LR}(#1)\xspace}
\newcommand{\LL}[1]{\texttt{LR}(#1)\xspace}
